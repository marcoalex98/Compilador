...
public class Lexico {
    ...
    String urlLog, lineaHoja, lineaAuxiliar, lexemaMultiple;
    ...
    int lineas, contadorParentesis, contadorCorchetes, contadorLlaves, lineaMulticomentario,
            lineaActual, activadorLexicoMultilinea, multiLinea, nT, nR, contadorIdentificadores,
            vueltaDesmenuzador, vueltaDeslexemizador;
...
//        System.out.println(oper.mostrarPrimero());
    ...
    String deslexemizador(String lexemaTokenizado) {//Elimina de la linea actual el lexema tokenizado
        System.out.println("--------------INICIO DESLEXEMIZADOR--------------");
